...
public class PrintTask {
    ...
    private final int orderOutTime = 2;
    ...
    public void doPrintAndAcceptOrder() {
        ...
        while (true) {
            ...
            if (redisSize < NumConstants.INT_NUM_1) {
                ...
                //先发送微信消息
                //发送所有的流水号
                //List<PrintDataDTO> dtoList = this.buildOrderDTO();
